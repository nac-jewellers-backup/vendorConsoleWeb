...
const Admins = () => {
        ...
        return (
            <div className='mx-2'>
                <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center mt-1">
                    <h5 className="m-0">Enquire Lists</h5>
    ...
    const actions = (rowData) => {
        return (
            <>
                <Toast ref={toast} />
                <ConfirmDialog />
                <Button icon="pi pi-pencil" severity="primary" className="mr-1 w-auto h-auto" tooltip="Edit Enquire" tooltipOptions={{ position: 'top' }} text onClick={() => router.push(`/pages/enquire/${rowData.id}`)} />
    ...
    useEffect(() => {
        ...
        document.title = 'Enquire Lists | NAC Vendor';
        getData();
    }, []);
    ...
    return (
        <>
            ...
            >
                ...
                />
                <Column
                    header='Title' headerStyle={{ 'minWidth': '40%', backgroundColor: '#d7e4fc', whiteSpace: 'nowrap' }} sortable
                    field='title' filterField="title" className='text-start'
                />
                <Column
                    header='Description' headerStyle={{ width: '10%', backgroundColor: '#d7e4fc', whiteSpace: 'nowrap' }} sortable
                    field='description' filterField="description" className='text-end'
                />
                <Column
                    header='Status' headerStyle={{ width: '26%', backgroundColor: '#d7e4fc', whiteSpace: 'nowrap' }} sortable
                    field='status' filterField="status" className='text-start'
                />
                <Column
